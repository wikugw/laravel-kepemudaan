...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
          <h1 class="m-0 text-dark">Sunting Data Program Kerja Kelurahan {{$kelurahan->nama_kelurahan}}</h1>
        @if ($errors->any())
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="card">
        <div class="card-body">
          <form class="" action=" {{route('kelurahan_program.update',['kelurahan'=>$kelurahan->id, 'program'=>$program_kerja->id])}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
