...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
          <h1 class="m-0 text-dark">Sunting Data Program Kerja Kecamatan {{$kecamatan->nama_kecamatan}}</h1>
        @if ($errors->any())
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="card">
        <div class="card-body">
          <form class="" action=" {{route('kecamatan_program.update',['kecamatan'=>$kecamatan->id,'program'=>$program_kerja->id])}}" method="post" enctype="multipart/form-data">
            @csrf
              @method('PUT')
