...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Pengelolaan Data Sarana Prasarana</h1>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div>
  ...
  <section class="content">
    ...
    @if(Session::has('Success'))
      ...
      @endif
      <a href="{{route('sarana_prasarana.create')}}" class="btn btn-primary mb-3 ">Tambah Data</a>
        ...
        <tbody>
          @foreach($data_sarana_prasarana as $key => $sarana_prasarana)
            <tr>
              ...
              <td>
                <a href="{{route('sarana_prasarana.edit',$sarana_prasarana->id)}}" class='btn btn-warning btn-sm'>Sunting</a>
                <form action="{{route('sarana_prasarana.destroy',$sarana_prasarana->id)}}" method="POST">
                  @csrf
                  @method('DELETE')
