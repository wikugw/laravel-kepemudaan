...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Tambah Data Sarana Prasarana Kelurahan {{$kelurahan->nama_kelurahan}}</h1>
        @if ($errors->any())
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="card">
        <div class="card-body">
          <form class="" action="{{route('sarana_prasarana.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('POST')
