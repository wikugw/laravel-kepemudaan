...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
          <h1 class="m-0 text-dark">Sunting Data Sarana Prasarana Kecamatan {{$kecamatan->nama_kecamatan}}</h1>
        @if ($errors->any())
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="card">
        <div class="card-body">
          <form class="" action=" {{route('kecamatan_sarana.update',['kecamatan'=>$kecamatan->id,'sarana'=>$sarana_prasarana->id])}}" method="post" enctype="multipart/form-data">
              @csrf
              @method('PUT')
