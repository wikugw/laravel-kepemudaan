...
class PeminjamanSaranaController extends Controller
{
    ...
    {
        $data_peminjaman_sarana = peminjaman_sarana::all();
      return view('admin/v_pengelolaan_peminjaman_sarana')->with(['data_peminjaman_sarana' => $data_peminjaman_sarana]);
    }
    ...
    {
        return view('admin/v_tambah_data_peminjaman_sarana');
    }
    ...
    {
        $peminjaman_sarana = peminjaman_sarana::find($id);
      return view('admin/v_sunting_data_peminjaman_sarana')->with(['peminjaman_sarana' => $peminjaman_sarana]);
    }
      ...
      $tanggalSekarang = $carbon->toDateString();
          ...
          if($tanggal_kembali < $tanggal_peminjaman){
            ...
            if ($isExist != null){
              ...
              Session::flash('Success', 'Berhasil menyunting data peminjaman');
            }
          }
          return redirect()->route('peminjaman_sarana');
    }
